  ...
  components: {
    MuiButton: {
      styleOverrides: {
        ...
        containedPrimary: {
          '&:hover': {
            boxShadow: '0px 4px 8px rgba(67, 100, 247, 0.3)',
          },
        },
      },
    },
...
// Add custom shadows to both themes
lightTheme.customShadows = {
  card: '0px 2px 8px rgba(0, 0, 0, 0.08)',
  dropdown: '0px 4px 16px rgba(0, 0, 0, 0.12)',
  modal: '0px 8px 32px rgba(0, 0, 0, 0.16)',
};

darkTheme.customShadows = {
  card: '0px 2px 8px rgba(0, 0, 0, 0.24)',
  dropdown: '0px 4px 16px rgba(0, 0, 0, 0.32)',
  modal: '0px 8px 32px rgba(0, 0, 0, 0.48)',
};

// Export utility function for getting theme by mode
